      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-5 sm:gap-6 items-start">
        ...
        <div className="md:col-span-5 lg:col-span-4 space-y-5">
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#1d1d1d] border border-[#2b2b2b] shadow-xl space-y-3">
            ...
            <form onSubmit={handleAddCategory} className="space-y-3">
              <input
                ...
                className="w-full px-3.5 py-2.5 rounded-xl bg-[#232323] border border-[#2b2b2b] focus:border-[#941e33] focus:outline-none text-xs sm:text-sm text-[#f1f2ed]"
              />
              <button
                type="submit"
                className="w-full py-2.5 px-4 rounded-xl bg-[#941e33] hover:bg-[#b8283f] text-white text-xs sm:text-sm font-bold flex items-center justify-center gap-2 shadow-lg shadow-[#941e33]/20 transition-all cursor-pointer"
              >
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#171717] border border-[#2b2b2b] shadow-lg space-y-3">
            <div className="flex items-center gap-2 text-[#941e33]">
                      ...
                      <div className="flex items-center gap-2.5 truncate">
                        ...
                        {onSelectCategory && (
                          <button
                            ...
                            className="px-2 py-0.5 rounded text-[10px] font-mono uppercase bg-[#232323] hover:bg-[#941e33] text-[#a8a6a1] hover:text-white transition-colors cursor-pointer"
                          >
                            {isAr ? 'اختيار' : 'Select'}
                          </button>
                        )}
