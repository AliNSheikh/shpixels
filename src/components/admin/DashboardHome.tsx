      ...
      <div className="p-5 sm:p-7 rounded-2xl bg-gradient-to-r from-[#1d1d1d] via-[#242424] to-[#1d1d1d] border border-[#2b2b2b] flex flex-col md:flex-row md:items-center justify-between gap-5 shadow-xl">
        ...
        <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 flex-shrink-0">
          <button
            ...
            className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2.5 rounded-xl bg-[#941e33]/20 hover:bg-[#941e33]/30 text-xs font-semibold text-[#b8283f] border border-[#941e33]/50 transition-colors cursor-pointer"
            title={isAr ? 'فتح المحرر المرئي المباشر على الموقع العام' : 'Launch visual in-place live editor on public site'}
          >
            <Sparkles className="w-4 h-4" />
            <span>{isAr ? 'المحرر المرئي المباشر' : 'Live Visual Editor'}</span>
          </button>
          ...
          <button
            onClick={exportJson}
            className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-2.5 rounded-xl bg-[#941e33] hover:bg-[#b8283f] text-xs font-semibold text-white transition-all shadow-md shadow-[#941e33]/20 cursor-pointer"
          >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
        ...
        >
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            ...
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-[#232323] text-[#b8283f] group-hover:bg-[#941e33] group-hover:text-white flex items-center justify-center transition-colors flex-shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 items-start">
          ...
          <div className="rounded-2xl bg-[#171717] border border-[#2b2b2b] shadow-xl overflow-hidden">
            <div className="p-4 sm:p-5 border-b border-[#2b2b2b] flex items-center justify-between gap-3">
              <div className="flex items-center gap-2.5">
                <div className="w-8 h-8 rounded-lg bg-[#941e33]/20 border border-[#941e33]/40 flex items-center justify-center text-[#b8283f] flex-shrink-0">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#941e33] hover:bg-[#b8283f] text-white text-xs font-bold shadow-md shadow-[#941e33]/20 transition-all cursor-pointer whitespace-nowrap"
              >
            ...
            <div className="p-3 bg-[#1c1c1c] border-b border-[#2b2b2b]">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-1.5 rounded-lg bg-[#141414] border border-[#2b2b2b] text-xs text-[#f1f2ed] placeholder-[#706e6a] focus:outline-none focus:border-[#941e33]"
                />
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                      <div className="relative w-16 h-11 sm:w-20 sm:h-12 rounded-lg overflow-hidden bg-[#232323] border border-[#2b2b2b] flex-shrink-0">
                        ...
                        {project.videos && project.videos.length > 0 && (
                          <span className="absolute bottom-0.5 right-0.5 p-0.5 rounded bg-black/80 text-[#941e33]">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5 flex-wrap">
                          ...
                          {project.featured && (
                            <span className="px-1.5 py-0.2 rounded text-[9px] font-mono bg-[#941e33]/20 text-[#b8283f] border border-[#941e33]/30">
                              {isAr ? 'مميز' : 'Featured'}
                            </span>
                          )}
                        </div>
            ...
            <div className="p-3 sm:p-4 bg-[#141414] border-t border-[#2b2b2b] flex items-center justify-between text-xs">
              ...
              <button
                onClick={() => onNavigate('projects')}
                className="text-[#941e33] hover:text-[#b8283f] font-semibold flex items-center gap-1 cursor-pointer transition-colors"
              >
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#171717] border border-[#2b2b2b] shadow-xl space-y-4">
            <div className="flex items-center justify-between gap-3">
              ...
              >
                ...
                <ArrowUpRight className="w-3 h-3 text-[#941e33]" />
              </button>
            </div>
            ...
            <form onSubmit={handleQuickAddCategory} className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2 rounded-xl bg-[#232323] border border-[#2b2b2b] text-xs text-[#f1f2ed] placeholder-[#706e6a] focus:outline-none focus:border-[#941e33]"
              />
              <button
                type="submit"
                className="px-3.5 py-2 rounded-xl bg-[#941e33] hover:bg-[#b8283f] text-white text-xs font-bold transition-colors cursor-pointer flex items-center gap-1 whitespace-nowrap"
              >
                <Plus className="w-3.5 h-3.5" />
            ...
            <div className="flex flex-wrap gap-2 pt-1">
              {categories.map((cat) => {
                ...
                return (
                  ...
                  >
                    <span>{cat}</span>
                    <span className="px-1.5 py-0.2 rounded-full text-[10px] font-mono bg-[#141414] text-[#b8283f] border border-[#941e33]/30">
                      {count}
                    </span>
                  </div>
                );
              ...
              <form onSubmit={handleSaveShowreelVideo} className="flex-1 w-full space-y-2">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 rounded-xl bg-[#232323] border border-[#2b2b2b] text-xs font-mono text-[#f1f2ed] focus:outline-none focus:border-[#941e33]"
                  />
                  <button
                    type="submit"
                    className="px-3.5 py-2 rounded-xl bg-[#941e33] hover:bg-[#b8283f] text-white text-xs font-bold transition-colors cursor-pointer whitespace-nowrap"
                  >
                    {isAr ? 'حفظ' : 'Save'}
                  </button>
                </div>
        ...
        <div className="space-y-5 sm:space-y-6">
              ...
              {sectionCards.map((sec) => {
                ...
                return (
                  <div
                    key={sec.id}
                    onClick={() => onNavigate('sections')}
                    className="p-3 rounded-xl bg-[#232323] border border-[#2b2b2b] hover:border-[#941e33]/40 transition-colors cursor-pointer group flex items-center justify-between gap-3"
                  >
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#171717] border border-[#2b2b2b] shadow-xl space-y-4">
            ...
            <div className="relative border-2 border-dashed border-[#2b2b2b] hover:border-[#941e33]/50 rounded-2xl p-4 text-center bg-[#1e1e1e] transition-colors group cursor-pointer">
              <input
                type="file"
                accept="image/*"
              ...
              <div className="flex flex-col items-center justify-center space-y-1.5">
                <div className="w-9 h-9 rounded-xl bg-[#282828] text-[#941e33] flex items-center justify-center group-hover:scale-105 transition-transform">
              ...
              <div className="p-3 rounded-xl bg-[#232323] border border-[#2b2b2b] flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-1.5 flex-shrink-0">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-lg bg-[#941e33] hover:bg-[#b8283f] text-[11px] text-white font-bold transition-colors flex items-center gap-1 cursor-pointer"
                  >
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-[#171717] border border-[#2b2b2b] shadow-xl space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              >
                <Download className="w-3.5 h-3.5 text-[#941e33]" />
