...
export const initialContent: GlobalContent = {
  seo: {
    pageTitle: "MOGRAFIX | Videographer & Creative Visual Filmmaker",
    metaDescription: "MOGRAFIX - Professional videography, commercial brand ads, weddings, creative productions, and AI-driven motion graphics by Mohammad Abdallah.",
    ogTitle: "MOGRAFIX - Visual Storytelling Through Cinematic Motion",
    ogDescription: "7+ years of bringing ideas to life through cinematic filmmaking, commercial advertising, and AI-driven motion graphics.",
    ogImage: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?auto=format&fit=crop&w=1200&q=80",
    canonicalUrl: "https://mografix.com/",
    favicon: "/favicon.ico",
  ...
  branding: {
    logoText: "MOGRAFIX",
    logoSubtext: "FILMMAKER & CREATIVE STUDIO",
    accentColor: "#941e33"
  },
  navigation: [
  ...
  hero: {
    ...
    subtitle: "7+ years crafting high-impact commercial ads, emotionally resonant wedding films, healthcare storytelling, and cutting-edge AI motion graphics.",
    badgeText: "VIDEOGRAPHER & CREATIVE DIRECTOR",
  ...
  about: {
    badge: "THE CREATIVE BEHIND THE LENS",
    heading: "Crafting visual stories that linger in the memory.",
    highlightText: "Mohammad Abdallah (Mo) — Filmmaker & Visual Storyteller",
    bioParagraphs: [
      "With over seven years behind the camera, I specialize in transforming concepts into compelling cinematic narratives. Originating from Syria and operating internationally, my work bridges raw human emotion and sharp commercial visual precision.",
      "At MOGRAFIX, every frame is engineered with intention. Whether directing a high-energy brand advertisement, capturing intimate wedding vows, detailing sensitive medical procedures, or producing synthetic AI-assisted motion sequences, my philosophy remains constant: authentic emotion elevated by uncompromising cinematic craftsmanship.",
      "Equipped with modern cinema cameras (RED & Sony Cinema Line), DJI certified aerial systems, and an advanced DaVinci Resolve color grading suite, I deliver end-to-end visual solutions tailored for modern digital screens and international broadcasts."
    ],
  ...
  featuredVideos: [
    {
      ...
      description: "A curated 2-minute visual journey showcasing commercial advertisements, dramatic drone perspectives, medical precision, and AI motion sequences.",
      category: "Showreel",
      featured: true,
      order: 1,
      visible: true,
      caption: "Resolution: 4K UHD • Color: DaVinci Resolve Wide Gamut • Audio: Spatial Stereo",
      client: "MOGRAFIX Studio"
    },
    {
      id: "fvid-2",
  ...
  contact: {
    email: "contact@mografix.com",
    phone: "+963 99 123 4567",
    whatsapp: "https://wa.me/963991234567",
    location: "Syria • Available Globally for Remote & On-Location Projects",
    instagram: "https://instagram.com/mografiix",
    youtube: "https://youtube.com/@mografix",
    tiktok: "https://tiktok.com/@mografiix",
    linkedin: "https://linkedin.com/in/mohammad-abdallah-mografix",
    behance: "https://behance.net/mografix",
    ctaHeading: "LET'S CREATE SOMETHING UNFORGETTABLE",
    ctaSubtitle: "Have a commercial campaign, wedding, medical production, or creative concept? Share your vision and let's craft cinematic impact together.",
    responseTimeNote: "Typically responds within 24 hours on business days."
  },
  footer: {
    copyrightText: "© 2026 MOGRAFIX. All rights reserved. Directed by Mohammad Abdallah.",
    quote: "Every frame carries purpose. Every story deserves cinematic depth.",
    disclaimer: "Professional videographer portfolio & creative production studio."
  },
  categories: [
    "Commercial & Brand Ads",
    "Sport & Gym",
